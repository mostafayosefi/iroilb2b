<template>
    <div class="content ">
        ...
        <header-admin :user="user"
            ...
            <button v-show="user.role.table.edit" type="button" @click="getPdf()"
        ...
        <div v-show="user.role.table.edit" class="box intro-y p-4">
            ...
            <input dir="ltr" type="text"
                   class="form-control mt-2" :placeholder="$t('water-marker')"
                   v-model="table.water">
            <input dir="ltr" type="text"
        ...
        getPdf() {
            if (this.table.title != '') {
                ...
                axios.get("/table/pdf", {
                    ...
                    link.href = url;
                    link.setAttribute("download", this.table.title.toLowerCase() + ' ' + this.table.detail.description.toLowerCase() + '.pdf');
