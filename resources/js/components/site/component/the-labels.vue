<template>
    ...
    <div class="w-full md:w-4/5 mx-auto mt-4 px-2 md:px-2">
    ...
    beforeCreate() {
        axios.get('/blog/labels',
            ...
            if (response.data == 'null') {
                ...
                this.labels.title = response.data.label.title
                this.labels.description = response.data.label.description
            ...
            document.querySelector('meta[name="description"]').setAttribute("content", response.data.label.description.substring(0, 320));
        })
    },
