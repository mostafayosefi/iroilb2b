                                                    ...
                                                    <div class="space-y-2"
                                                        ...
                                                        <section>
                                                            <button type="button" @click="toggleModal()"
                                                                    class="btn bg-white-primary py-1 px-2 rounded-full text-sm">
                                                                <label for="upload-logo" class="cursor-pointer">
                                                                    {{
                                                                        company.data.logo ? $t('change-logo', language) : $t('upload-logo', language)
                                                                    }}
                                                                </label>
                                                            </button>
                                                            <input id="upload-logo" ref="FileInput" type="file"
                                                                   style="display: none;" @change="onFileSelect"/>
                                                            <a class="underline mx-2"
                                                               :href="$sitename + 'upload/company/logo/' + company.data.logo">
                                                                {{ company.data.logo }}
                                                            </a>
                                                        </section>
                                                        <section>
                                                            <button type="button"
                                                                    class="btn bg-white-primary py-1 px-2 rounded-full">
                                                                <label for="document-one" class="cursor-pointer">
                                                                    {{
                                                                        company.data.documentOne ? $t('change', language) : $t('upload', language)
                                                                    }}
                                                                    {{ " " + $t('ceo-pass', language) }}
                                                                </label>
                                                            </button>
                                                            ...
                                                            <a class="underline mx-2"
                                                               :href="$sitename + 'upload/company/doc/' + company.data.documentOne">
                                                                {{ company.data.documentOne }}
                                                            </a>
                                                        </section>
                                                        <section>
                                                            <button type="button"
                                                                ...
                                                                <label for="document-tow" class="cursor-pointer">
                                                                    {{
                                                                        company.data.documentTow ? $t('change', language) : $t('upload', language)
                                                                    }}
                                                                    {{
                                                                        " " + $t('statute', language)
                                                                    }}
                                                            ...
                                                            <a class="underline mx-2"
                                                               :href="$sitename + 'upload/company/doc/' + company.data.documentTow">
                                                                {{ company.data.documentTow }}
                                                            </a>
                                                        </section>
                                                        <section>
                                                            <button type="button"
                                                                ...
                                                                <label for="document-three" class="cursor-pointer">
                                                                    {{
                                                                        company.data.documentThree ? $t('change', language) : $t('upload', language)
                                                                    }}
                                                                    {{
                                                                        " " + $t('statute', language)
                                                                    }}
                                                            ...
                                                            <a class="underline mx-2"
                                                               :href="$sitename + 'upload/company/doc/' + company.data.documentThree">
                                                                {{ company.data.documentThree }}
                                                            </a>
                                                        </section>
                                                    </div>
                                                    <div
...
export default {
    ...
    methods: {
        ...
        toggleModal: function () {
            ...
            this.company.upload.logo = this.$refs.cropper.getCroppedCanvas().toDataURL();
        },
        onFileSelect(e) {
        ...
        onChangeDocOne() {
            this.company.upload.documentOne = this.$refs["document-one"].files[0];
        },
        onChangeDocTow() {
            this.company.upload.documentTow = this.$refs["document-tow"].files[0];
        },
        onChangeDocThree() {
            this.company.upload.documentThree = this.$refs["document-three"].files[0];
        },
        ...
        submitForm() {
            ...
            formData.append('user', this.$cookies.get('user').id);
            ...
            formData.append('logo', this.company.upload.logo)
            formData.append('document_one', this.company.upload.documentOne)
            formData.append('document_tow', this.company.upload.documentTow)
            formData.append('document_three', this.company.upload.documentThree)
            axios.post('/company/update/' + this.company.id,
                formData,
                {
                    headers: {
    ...
    async created() {
        ...
        await axios.get('/company/get/user/' + this.$route.params.id, {
            params: {
            ...
            for (const res of response.data.tag) {
                this.company.data.tags.push(res);
            }
